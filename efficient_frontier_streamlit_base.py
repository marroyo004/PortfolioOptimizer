    ...
    if find_frontier == True:
        ...
        if returns_method == "projected_prices":
            ...
            for i in tickers:
                ...
                projected_col1, projected_col2, projected_col3 = st.columns(3)
...
st.write('Created by Matias Arroyo')
st.write("[GitHub](https://github.com/marroyo004) |", 
         "[LinkedIn](https://www.linkedin.com/in/matias-arroyo/) |",
         "[Medium](https://medium.com/@matiasarroyo)")
